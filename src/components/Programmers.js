...
export default function Programmers() {
  ...
  const [programmers, updateProgrammers] = React.useState(listOfAwesome);
  const [featured, updateFeatured] = React.useState();
  ...
  const style = {
    fontSize: '1.5em',
    marginTop: '0.5em',
    color: featured ? 'khaki' : 'royalblue', // 🤔
  };
